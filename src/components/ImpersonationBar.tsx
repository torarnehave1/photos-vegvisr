...
// Read the raw `user` blob directly — same payload the photos app reads for its
// X-API-Token (readStoredUserSafe). Self-contained: no change to shared auth.
...
/**
 * System Owner "Login as…" control — ported from the vemotion app.
 *
...
export default function ImpersonationBar() {
  ...
  if (impersonating) {
    return (
      <div className="mt-4 flex items-center justify-between gap-3 rounded-xl px-4 py-2 bg-amber-600 text-white text-sm">
  ...
  return (
    <div className="mt-4 flex flex-wrap items-center gap-2 rounded-xl px-4 py-2 bg-slate-800/60 border border-slate-700 text-sm">
